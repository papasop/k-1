    ...
    <a href="https://colab.research.google.com/github/papasop/k-
1/blob/main/k1_colab.ipynb"><img 
src="https://colab.research.google.com/assets/colab-badge.svg"></a>
    <a href="https://opensource.org/licenses/MIT"><img 
src="https://img.shields.io/badge/License-MIT-yellow.svg"></a>
    <a href="https://www.python.org/downloads/"><img 
src="https://img.shields.io/badge/python-3.8+-blue.svg"></a>
    ...
    - **Code generation** – produce working code from a natural-language 
description
 ...
 --------|
    ...
    | `CODEX_MAX_RETRIES`   | `3`                  | Retry attempts on failure
              |
    | `CODEX_RETRY_DELAY`   | `1.0`                | Base delay between retries 
(s)     |
    | `CODEX_CACHE_ENABLED` | `false`              | Enable in-memory response 
cache    |
