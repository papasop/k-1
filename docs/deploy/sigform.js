...
(function(){
  ...
  function init(){
    ...
    function update(){
      ...
      // de Sitter has R_μν = Λ g_μν with Λ = -3 C₃. In this gauge:
      //   R_θθ = Λ g_θθ = Λ r²  →  1 − K₂ = Λ r²  →  K₂ = 1 − Λ r²
      //   R_tt  = Λ g_tt  = −Λ f  →  (f/r²)(K₁−K₂) = −Λf  →  K₁ − K₂ = −Λr²
      //                                                →  K₁ = 1 − 2Λr²
      // So the Λ-modified form is DIFFERENT targets for σ₁ and σ₂ legs.
      const Lam = -3*C3;
