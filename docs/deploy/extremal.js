  ...
  function mount(){
      ...
      <div class="ac-grid" style="grid-template-columns: 320px 1fr; gap:28px;">
        ...
        <div>
          ...
          <div class="ac-stats" style="margin-top:12px;color:var(--muted);font-size:0.85em;line-height:1.55">
            <b>Reading.</b> Outside the horizon (f&gt;0), R_μν = 0 holds at every point.
            But the K-pair is <i>not</i> (1,1) — RN sits on the second leg of Theorem 5.2 (R_μν=0 ⇒ K₁ K₂ = 1, not K₁=K₂=1).
            <br>The horizon r₊ pulls K₁ toward 0 and K₂ toward a finite value; in the extremal limit Q→M these become a sharp pinch:
            K₁(r₊) = 0 and K₂(r₊) = 0 simultaneously, the geometry near r₊ approaches AdS₂ × S².
          </div>
        </div>
      </div>`;
    ...
    function update(){
      ...
      if (!Number.isFinite(rh)){
        ...
        // Schwarzschild: pure vacuum, both K=1
        ...
        // RN exterior: K₁=1 identically, K₂ = 1 - Q²/r² ≠ 1, R_tt ≠ 0 (vacuum FAILS)
      ...
      // ----- canvas: K₁(r), K₂(r) on [r₊·(1+1e-3), r₊·3] log-x -----
      ...
      // gridline at y=1 (the K=1 fixed point)
